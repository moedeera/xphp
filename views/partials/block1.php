...
function generateBlock1($data = []) {
    ...
    $html = '<div class="my-8 px-2 md:px-0 md:w-4/5 mx-auto flex flex-col-reverse md:grid md:grid-cols-2"
    ...
    $html .= '</div>' .
             '<div class="h-56 min-w-56 bg-bottom bg-cover md:min-h-56 md:h-full" ' .
